...
class ProfileMyList extends React.Component{
  constructor(props){
    super(props);
  }

  componentDidMount() {
    (document.getElementById('four') === null)? pass() : (document.getElementById('four').style.backgroundColor = '#272727')
  }

  componentWillUnmount() {
    (document.getElementById('four') === null)? pass() : (document.getElementById('four').style.backgroundColor = '')
  }
      ...
      <Grid style={{marginTop: 60,}} container spacing={0} justifyContent='center'> 
          ...
          <Grid style={{}} item xs={12} sm={8}>
            ...
            <div className={classes.content}>
              <Typography id={'My Anime List'} className={classes.heading}  variant='h4'>
                My Anime List
              </Typography>
              <ListTopAnime />
              <Typography id={'My Manga List'} style={{margin:'-30px 0px 10px 0', paddingTop: 70}} variant='h4'>
                My Manga List
              </Typography>
              <ListTopAnime />
              <Typography id={'My Manhwa List'} style={{margin:'-30px 0px 10px 0', paddingTop: 70}} variant='h4'>
                My Manhwa List
              </Typography>
              <ListTopAnime />
            </div>
...
export default withStyles(useStyles)(ProfileMyList);
